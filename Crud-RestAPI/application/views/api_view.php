...
<body>
    <div class="container">
        <br />
        <h3 align="center">REST API FOR VEGEEBOX</h3>
        <br />
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-md-6">
                        <h3 class="panel-title">Vegeebox's Admin Data</h3>
                    </div>
        ...
        <form method="post" id="user_form">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Add Admin(s)</h4>
                </div>
                <div class="modal-body">
                    <label>Enter Username</label>
                    <input type="text" name="username" id="username" class="form-control" />
                    <span id="admin_username_error" class="text-danger"></span>
                    <br />
    ...
    $(document).on('submit', '#user_form', function(event){
        ...
        $.ajax({
            ...
            success:function(data)
            {
                ...
                if(data.error)
                {
                    $('#admin_username_error').html(data.admin_username_error);
                    $('#admin_password_error').html(data.admin_password_error);
                }
            }
        })
    });
